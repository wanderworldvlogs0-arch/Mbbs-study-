  ...
  return (
    <AppLayout pageTitle="PDF Library">
      <div className="p-5 md:p-8 max-w-7xl mx-auto flex flex-col gap-6 md:gap-8">
        <div>
          <h1 className="text-2xl md:text-3xl font-extrabold text-slate-900 tracking-tight">PDF Library</h1>
          <p className="text-slate-500 mt-1.5 text-sm md:text-base">Browse study PDFs across all subjects</p>
        </div>
        ...
        {pdfs === null ? (
          <div className="p-8 text-center text-slate-400">Loading PDFs…</div>
        ) : filtered.length === 0 ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
            {filtered.map((pdf) => (
              ...
              >
                ...
                <div>
                  <div className="text-[10px] font-bold uppercase tracking-wider text-green-600 mb-1.5 flex items-center gap-1.5">
                  ...
                  <div className="text-xs text-slate-500 font-medium mt-2">{pdf.pageCount} pages</div>
                </div>
              </a>
            ))}
          </div>
